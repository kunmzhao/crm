...
urlpatterns = [
    ...
    url('^permmision/add/(?P<second_menu_id>\d+)$', menu.permission_add, name='permission_add'),
    ...
    url('^distribute/permissions/$', menu.distribute_permissions, name='distribute_permissions'),
